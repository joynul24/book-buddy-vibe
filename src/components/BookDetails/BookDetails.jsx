            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="md:w-2/3 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-4 mt-6 font-2">
                        <button className="px-6 py-2 bg-[#50B1C9] text-white font-semibold rounded-lg shadow hover:bg-cyan-700 transition"> Read To Book </button>
                          <button className="px-6 py-2 bg-[#23BE0A] text-white font-semibold rounded-lg shadow hover:bg-green-700 transition">  Wishlist to Book </button>
                    </div>
                </div>
            </div>
        </div>
